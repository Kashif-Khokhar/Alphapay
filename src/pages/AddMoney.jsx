            ...
            <form onSubmit={handleAdd} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                {methods.map((method) => (
                  <label 
                    key={method.id}
                    className="flex items-center gap-4 p-5 rounded-2xl border border-white/5 cursor-pointer hover:bg-white/5 transition-all has-[:checked]:border-primary/50 has-[:checked]:bg-primary/5"
                  >
